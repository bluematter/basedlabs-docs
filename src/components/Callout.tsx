...
const styles = {
  note: {
    container:
      'bg-indigo-50 dark:bg-slate-800/60 dark:ring-1 dark:ring-slate-300/10',
    title: 'text-indigo-900 dark:text-indigo-400',
    body: 'text-indigo-800 [--tw-prose-background:theme(colors.sky.50)] prose-a:text-indigo-900 prose-code:text-indigo-900 dark:text-slate-300 dark:prose-code:text-slate-300',
  },
  warning: {
    container:
