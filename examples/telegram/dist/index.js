        ...
        if (msg.text === '/test@basedlabs_bot') {
            try {
                const createResponse = await basedlabs.createImage({
                    prompt: 'In the style of TOK (a pink giraffe) wearing jeans, red boxing gloves, vegas background, masterpiece, best quality, high detail, sharp focus, soft lighting, high quality,(photorealistic:1.4), 8K, (masterpiece*high detailed*highres), 8k, cinematic quality',
